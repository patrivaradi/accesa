...
const APIkey = "c09199b27d844a6aa3f144008232404";
      ...
      .then((data) => {
        ...
        if (hour < 8 || hour > 19) {
          document.getElementById("body").style.backgroundImage =
            'url("https://images.unsplash.com/photo-1632446628687-127cf068a522?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80")';
        }
        ...
        data.forecast.forecastday.forEach((day, idx) => {
          ...
          forecast.innerHTML += `<div class="weather-forecast">
                    ...
                    <img src="${
                      data.forecast.forecastday[idx].day.condition.icon
                    }" alt="Weather icon" class="forecast_icon">
                    <div class="temp_day">${
                      data.forecast.forecastday[idx].day.maxtemp_c
                    }&#176; C</div>
                    <div class="temp_night">${
                      data.forecast.forecastday[idx].day.mintemp_c
                    }&#176; C</div>
                </div>`;
        });
      });
